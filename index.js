...
global.mods = ['5512997277680@s.whatsapp.net']
global.prems = []

global.dfail = (type, m, conn) => {
  let msg = {
    owner: '👺Este comando só pode ser usado pelo Proprietário do bot!👺',
