...
class Image {
  ...
  replaceFrame(path, frame) {
    ...
    return _asyncToGenerator(function* () {
      ...
      switch (_this3.anim.frames[frame].type) {
        ...
        default:
          throw new Error("Tipo de frame desconhecido");
      }
  ...
  static muxAnim({
    ...
    return _asyncToGenerator(function* () {
      ...
      if (frames.length == 0) {
        throw new Error("Sem frames para mux");
      } else if (_width <= 0 || _width > 1 << 24) {
        throw new Error("Largura fora do intervalo");
      } else if (_height <= 0 || _height > 1 << 24) {
        throw new Error("Altura fora do alcance");
      } else if (_height * _width > Math.pow(2, 32) - 1) {
        throw new Error(`Width*height too large (${_width}, ${_height})`);
      } else if (loops < 0 || loops >= 1 << 24) {
        throw new Error("Loops fora de alcance");
      } else if (delay < 0 || delay >= 1 << 24) {
        throw new Error("Atraso fora do alcance");
      } else if (x < 0 || x >= 1 << 24) {
        throw new Error("X fora do alcance");
      } else if (y < 0 || y >= 1 << 24) {
        throw new Error("Y fora de alcance");
      }
...
var _demuxFrame2 = /*#__PURE__*/ (function () {
  var _demuxFrame3 = _asyncToGenerator(function* (path, frame) {
    ...
    if (frame.vp8l) {
      ...
      throw new Error("Quadro não tem VP8/VP8L?");
    }
...
var _readHeader2 = /*#__PURE__*/ (function () {
  var _readHeader3 = _asyncToGenerator(function* (fd) {
    ...
    if (buf.toString("utf8", 0, 4) != "RIFF") {
      throw new Error("Cabeçalho inválido (não RIFF)");
    }

    if (buf.toString("utf8", 8, 12) != "WEBP") {
      throw new Error("Cabeçalho inválido (não WEBP)");
    }
...
var _readChunkHeader2 = /*#__PURE__*/ (function () {
  var _readChunkHeader3 = _asyncToGenerator(function* (fd) {
    ...
    if (bytesRead == 0) {
      ...
      throw new Error("Fim do arquivo alcançado durante a leitura do cabeçalho do bloco");
    }
...
var _readChunk_VP2 = /*#__PURE__*/ (function () {
  var _readChunk_VP3 = _asyncToGenerator(function* (fd, size) {
    ...
    if (bytesRead != size) {
      throw new Error("Fim do arquivo alcançado durante a leitura do bloco VP8");
    }
...
var _readChunk_VP8_buf2 = function _readChunk_VP8_buf2(buf, size, cursor) {
  if (cursor >= buf.length) {
    throw new Error("Fim do buffer alcançado durante a leitura do bloco VP8");
  }
...
var _readChunk_VP8L2 = /*#__PURE__*/ (function () {
  var _readChunk_VP8L3 = _asyncToGenerator(function* (fd, size) {
    ...
    if (bytesRead != size) {
      throw new Error("Fim do arquivo alcançado durante a leitura do fragmento VP8L");
    }
...
var _readChunk_VP8L_buf2 = function _readChunk_VP8L_buf2(buf, size, cursor) {
  if (cursor >= buf.length) {
    throw new Error("Alcançou o final do buffer durante a leitura do bloco VP8L");
  }
...
var _readChunk_VP8X2 = /*#__PURE__*/ (function () {
  var _readChunk_VP8X3 = _asyncToGenerator(function* (fd, size) {
    ...
    if (bytesRead != size) {
      throw new Error("Fim do arquivo alcançado durante a leitura do fragmento VP8X");
    }
...
var _readChunk_ANIM2 = /*#__PURE__*/ (function () {
  var _readChunk_ANIM3 = _asyncToGenerator(function* (fd, size) {
    ...
    if (bytesRead != size) {
      throw new Error("Fim do arquivo atingido durante a leitura do trecho ANIM");
    }
...
var _readChunk_ANMF2 = /*#__PURE__*/ (function () {
  var _readChunk_ANMF3 = _asyncToGenerator(function* (fd, size) {
    ...
    if (bytesRead != size) {
      throw new Error("Fim do arquivo alcançado durante a leitura do trecho ANMF");
    }
...
var _readChunk_ALPH_buf2 = function _readChunk_ALPH_buf2(buf, size, cursor) {
  if (cusor >= buf.length) {
    throw new Error("Atingido o final do buffer durante a leitura do trecho ALPH");
  }
...
var _readChunk_Skip2 = /*#__PURE__*/ (function () {
  var _readChunk_Skip3 = _asyncToGenerator(function* (fd, size) {
    ...
    if (bytesRead != size) {
      throw new Error("Fim do arquivo alcançado ao pular parte");
    }
